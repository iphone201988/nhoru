...
//                    
//                    if let renewalDate = transaction.expirationDate {
//                        if let nextDay = Calendar.current.date(byAdding: .day, value: 1, to: renewalDate) {
//                            subscriptionExpiry = nextDay.ISO8601Format()
//                        }
//                    } else {
...
//                    SharedMethods.debugLog("⭐ Received background transaction: \(transaction.productID)")
//                    await transaction.finish()
//                }
//            }
//        }
